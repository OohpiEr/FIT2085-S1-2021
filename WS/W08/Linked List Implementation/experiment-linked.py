...
if __name__ == '__main__':
    ...
    for n in range(1, 201, 2):
        ...
        t1, t2 = experiment(LinkedList, words[:(10 * n)])
        times21.append(t1)
        times22.append(t2)

    coords = []
    coords.append([10 * n for n in range(1, 201, 2)])
    ...
    lgtext = ['array insert()', 'array delete_at_index()', 'linked insert()', 'linked delete_at_index()']
